...
16. [Find Numbers with Even Number of Digits](https://leetcode.com/problems/find-numbers-with-even-number-of-digits/) # to optimise quadratic to linear,  instead of counting 
          digits using division by 10 use the formula.  digits(n) = |_ log10(n) _| + 1    (meaning floor of log10(num)  ) added to 1 #
